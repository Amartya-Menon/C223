...
if not zipf: 
    print('the zipped file/folder is not password proteced! You can successfully open it!')
else:
    starttime = time.time() 
...
if result == 0:
    print('sorry password is not found.A total of'+str(c)+"+possible combinations tried in"+str(duration)+"seconds. Password is not of 4 characters") 
else:
